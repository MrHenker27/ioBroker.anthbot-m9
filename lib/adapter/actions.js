...
/**
 * @param {{ context: { shadowClient: object, areaDefinition?: object|null, lastReported?: object, device: { model?: string|null } }, command: string, value: unknown }} params
...
/**
 * @param {{ context: { lastReported?: object, shadowClient: object, device: { model?: string|null } }, control: string, value: unknown }} params
 * @returns {Promise<void>}
 */
