...
const { renderRtkSkyplot } = require('../anthbot/rtk-skyplot');
...
function buildDeviceStateUpdates({ context, data, eventCodeCache, errorDescriptionLanguage, now }) {
    ...
    return {
        ...
        'diagnostics.gnss.base.satelliteList': JSON.stringify(data?._rtk_satellite_info?.satellites || []),
        'diagnostics.gnss.base.skyplotSvg': renderRtkSkyplot(data?._rtk_satellite_info?.satellites || []),
