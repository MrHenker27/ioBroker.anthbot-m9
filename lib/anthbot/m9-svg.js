...
function buildM9Svg(mapData, options = {}) {
    ...
    if (layers.showCurrentTrack && pathPoints.length >= 2) {
        parts.push(`<polyline clip-path="url(#m9-map-clip)" points="${pointString(pathPoints)}" fill="none" stroke="#3887d6" stroke-width="75" stroke-linecap="round" stroke-linejoin="round" opacity="0.90"/>`);
    }
