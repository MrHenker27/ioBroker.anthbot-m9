 ...
 *
 * @param {*} value - Seconds since epoch or formatted timestamp string
...
class AnthbotShadowApiClient {
    ...
    /**
     * Make a signed POST request to the AWS IoT endpoint.
     *
     * @param {object} params - Request parameters
     * @param {string} params.requestUri - Request URI
     * @param {string} params.canonicalQuery - Canonical query string
     * @param {Buffer} params.payloadBytes - Request payload bytes
     * @param {boolean} params.includeSdkHeaders - Whether to include SDK headers
     * @param {string|null} [params.canonicalUriOverride] - Optional canonical URI override
     * @param {boolean} [params.signContentLength] - Whether to sign the content length header
     * @returns {Promise<object>} - Signed request response
     */
    async signedPost({
        requestUri,
        canonicalQuery,
     ...
     * @param {*} [params.data] - Optional command payload
 ...
 *
 * @param {*} value - Command selection input
