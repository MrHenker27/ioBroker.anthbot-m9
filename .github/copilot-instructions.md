...
9. [anthbot-genie-Specific Development Patterns](#anthbot-genie-specific-development-patterns)
...
- **Adapter Name**: iobroker.anthbot-genie
- **Primary Function**: Integrate anthbot-genie mower via cloud API and local network protocols
- **Repository**: reloxx13/ioBroker.anthbot-genie
- **Target Devices**: anthbot mowers
- **Supported Generations**: 
  - Genie
- **Key Features**:
  - Device auto-discovery and configuration
  - Support for different anthbot device models
...
- **MQTT Protocol**: Primary communication method for all anthbot-genie generations
...
### State Management
- Follow ioBroker state naming conventions (e.g., `anthbot-genie.0.SHSW-25#1234567.Relay0.Switch`)
...
## anthbot-genie-Specific Development Patterns
